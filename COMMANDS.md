...
## !!burningtext
Generate a burning text gif.

**Variations**: `!!burningtext`, `!!flametext`, `!!cooltext`

**Usage**: `!!burningtext <text>`
### Example:

```
!!burningtext Burning Text
```
It burns.
## !!calcscore
...
## !!emojipedia
Look up what an emoji looks like on all platforms.
...
!!emojipedia 🤔
```
Returns thinking emoji information.
## !!emote
...
## !!scamge
See how much pp somebody or yourself is scammed out of.

**Usage**: `!!scamge [username]`
## !!score
...
## !!uptime
Check how long a Twitch channel has been live or how long it's been offline.
...
**Usage**: `!!w;`
## !!weather
Send the current weather for the given city.
...
!!weather London
```
Returns the current weather in London.
## !!with
