...
module.exports = {
    ...
    call: obj => {
        return new Promise((resolve, reject) => {
                ...
                Promise.all(requests).then(response => {
                    ...
                    if(recent_tracks.track.length == 0){
                        ...
                        if(track["@attr"] != undefined && track["@attr"].nowplaying == 'true'){
                            ...
                            listening_text = `Listened ${DateTime.fromSeconds(parseInt(track.date.uts)).toRelative()}`;
                        }else{
                            listening_text = 'Listened recently';
                        }
            ...
            // No username provided - check Discord presence
            if(msg.member && msg.member.presence && msg.member.presence.activities) {
